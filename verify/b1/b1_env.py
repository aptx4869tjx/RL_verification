...
class B1_Env():
    ...
    def __init__(self, divide_tool, network):
        self.initial_state = [0.8001, 0.5001]
        self.initial_state_region = [0.8, 0.5, 0.9, 0.6]
    ...
    def get_abstract_state_label(self, abstract_state, cnt):
        ...
        try:
            if state_list[0] >= 0 and state_list[2] <= 0.2 and state_list[1] >= 0.05 and state_list[3] <= 0.3:
                return ['goal', 'safe']
        except:
            print(state_list)
