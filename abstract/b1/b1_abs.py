...
pt_file0 = os.path.join(script_path, "b1_abs-actor.pt")
pt_file1 = os.path.join(script_path, "b1_abs-critic.pt")
pt_file2 = os.path.join(script_path, "b1_abs-actor-target.pt")
pt_file3 = os.path.join(script_path, "b1_abs-critic-target.pt")
